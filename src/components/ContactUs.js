    ...
    <div className="max-w-5xl mx-auto px-4 py-8">
      ...
      <section className="flex flex-col md:flex-row justify-between items-center gap-8 mb-12">
        <div className="flex flex-col items-center">
          ...
          <p className="text-lg">+44 (0)7515 789 661</p>
        </div>
        ...
        <div className="flex flex-col items-center">
          <h2 className="text-xl font-semibold mb-2">Fax</h2>
          <p className="text-lg">+44 (0)870 838 1365</p>
        </div>
      </section>
      ...
      <section className="bg-gray-100 p-6 rounded-lg">
        ...
        <form className="space-y-4 max-w-md mx-auto">
          ...
          <button 
            type="submit" 
            className="w-full bg-blue-600 text-white text-lg font-semibold py-2 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
            Send Message
          </button>
        </form>
